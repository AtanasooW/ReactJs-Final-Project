    ...
    public partial class PC : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersAddresses", x => new { x.AddressId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserIdLike = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.RatingId, x.UserIdLike });
                    table.ForeignKey(
                        name: "FK_Likes_AspNetUsers_UserIdLike",
                        column: x => x.UserIdLike,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Awaiting approval" },
                    { 2, "Confirmed" },
                    { 3, "The order is packaged" },
                    { 4, "The order has been delivered to a courier" }
                });
